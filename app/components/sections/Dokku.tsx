...
export default function Dokku() {
    return (
        <section id="dokku" className="py-10 text-gray-800 font-sans">
            <h2 className="text-center text-3xl md:text-5xl font-bold my-6 text-orange-600">
                Mednarodna filmska delavnica DoKKu
            </h2>

            <div className="px-24 pt-4 pb-16 flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-0">
                {/* Image block */}
                ...
                <div className="w-full md:w-1/2 flex items-center relative z-10 -ml-12 md:-ml-20 px-6 md:px-0 h-[620px]">
                    <article className="bg-white rounded-xl shadow-lg p-6 md:p-8 text-base leading-relaxed max-w-[500px] mx-auto text-justify">
                        <h3 className="text-xl  md:text-2xl font-semibold mb-4 text-orange-700">
            ...
            <div className="bg-zinc-100">
                <div className="px-24 py-12 flex flex-col justify-center md:flex-row gap-16">
                ...
                <p className="pt-6 pb-10 text-2xl md:text-3xl text-center font-semibold text-orange-700 tracking-widest">Vidimo se julija 2026!</p>
            </div>
